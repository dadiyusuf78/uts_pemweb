...
@can('book_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.data_pelanggan.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.data_pelanggan.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.data_pelanggan.title_singular') }} {{ trans('global.list') }}
    </div>
...
@can('data_pelanggan_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.data_pelanggan.massDestroy') }}",
